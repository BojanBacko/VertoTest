...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        LicenseName = "Verto UK Ltd";
        LicenseKey = "D22N-739T-XTMX-639J-UGYB-FGJH-VPR3";

		// The base URL used to reach files in CKFinder through the browser.
		BaseUrl = "/contentfiles/";
		...
		ResourceType type;
        type = ResourceType.Add("Download");
        type.Url = BaseUrl + "download/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "download/";
        type.MaxSize = 0;
